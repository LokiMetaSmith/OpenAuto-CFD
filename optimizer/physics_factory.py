...
class PhysicsEngineFactory:
    ...
    def get_driver(case_dir, config=None, **kwargs):
        """
        Returns an initialized physics driver (e.g., FoamDriver or OpenEMSDriver).
        ...
        if physics_type == 'cfd':
            ...
            raise ValueError(f"Unsupported physics type specified in config: '{physics_type}'. Supported types: 'cfd', 'em'.")
